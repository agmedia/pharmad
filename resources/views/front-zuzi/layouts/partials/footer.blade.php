    ...
    <div class="pt-0 ">
        ...
        <div class="container">
            ...
            <div class="d-md-flex justify-content-between pt-2">
                <div class="pb-4 fs-sm text-light  text-center text-md-start">© 2023. Sva prava pridržana Zuzi. Web by <a class="text-light" title="Izrada web shopa - B2C ili B2B web trgovina - AG media" href="https://www.agmedia.hr/usluge/izrada-web-shopa/" target="_blank" rel="noopener">AG media</a>
                </div>
