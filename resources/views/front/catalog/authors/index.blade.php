...
@section('title', 'Brendovi - Ljekarne PharmAD')
@section('description', 'Pregled svih brendova dostupnih u webshopu Ljekarne PharmAD.')
...
@section('content')
    ...
    <nav class="mb-4 text-center text-lg-start" aria-label="breadcrumb">
        <ol class="breadcrumb flex-lg-nowrap">
            ...
            <li class="breadcrumb-item text-nowrap active" aria-current="page"><a class="text-nowrap" href="{{ route('catalog.route.author') }}">Lista brendova</a></li>
    ...
    <section class="d-md-flex justify-content-between align-items-center mb-2 pb-2">
        <h1 class="h2 mb-1 mb-md-0 me-3">Lista brendova</h1>
        <form action="{{ route('pretrazi', ['tip' => 'author']) }}" method="get" >
            <div class="input-group input-group-lg flex-nowrap">
                <input type="text" class="form-control rounded-start" name="{{ config('settings.search_keyword') }}" placeholder="Pretražite po brendu">
