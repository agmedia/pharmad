@php($paymentInfoUrl = url('/info/nacini-placanja'))
                ...
                <div class="row py-4">
                    ...
                    <div class="col-md-4 d-none d-md-block text-center text-md-start mb-4">
                        <div class="widget widget-links widget-dark pb-2">
                            ...
                            <ul class="widget-list  ">
                                <li class="widget-list-item"><a href="{{ $paymentInfoUrl }}" class="widget-list-link" > kreditnom karticom jednokratno ili na rate</a></li>
                                <li class="widget-list-item"><a href="{{ $paymentInfoUrl }}" class="widget-list-link" > virmanom / općom uplatnicom / internet bankarstvom</a></li>
                                <li class="widget-list-item"><a href="{{ $paymentInfoUrl }}" class="widget-list-link" >gotovinom prilikom pouzeća</a></li>

                                <li class="widget-list-item"><a href="{{ $paymentInfoUrl }}" class="widget-list-link" >osobno preuzimanje i plaćanje u ljekarni</a></li>
                            </ul>
